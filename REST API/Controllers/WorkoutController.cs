...
namespace REST_API.Controllers
{
    ...
    public class WorkoutController : ControllerBase
    {
        ...
        [Authorize]
        [Route("get/newworkout/split/{splitId}/user/{userId}/abs/{includeAbs}/prioritizeFavs/{priorFavorites}")]
        [HttpGet]
        public IActionResult GetNewWorkout(int splitId, string userId, bool includeAbs, bool priorFavorites)
        {
            try
            {
                var apiResponse = _workoutUseCase.GenerateNewWorkout(splitId, userId, includeAbs, priorFavorites);
